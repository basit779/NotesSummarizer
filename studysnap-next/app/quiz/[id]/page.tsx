                ...
                return (
                  <motion.button
                    ...
                    className={cn(
                      ...
                      !revealed && 'border-black/[0.08] bg-black/[0.02] hover:bg-black/[0.05] hover:border-black/20 text-black/85',
                      revealed && !showCorrect && !showWrong && 'border-black/[0.06] bg-black/[0.02] text-black/40',
