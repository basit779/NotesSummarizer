  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-12">
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        ...
        <h1 className="mt-2 mono text-4xl md:text-5xl font-semibold tracking-tightest text-white">Hey, {firstName}.</h1>
        <p className="mt-2 text-white/55">Ready to turn notes into knowledge?</p>
      </motion.div>

      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.1 }} className="mt-10">
          ...
          <div className="relative flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
              ...
              <p className="mt-2 max-w-xl text-sm text-white/55">
                We extract text, route it through the best available AI model, and return summaries, flashcards, definitions, and exam questions.
              </p>
            </div>
            <Link href="/upload">
      ...
      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.18 }} className="mt-6 grid gap-4 md:grid-cols-3">
      ...
      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.26 }} className="mt-10">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link href="/history" className="mono text-xs text-white/50 hover:text-mint-400 transition-colors cursor-pointer inline-flex items-center gap-1">
