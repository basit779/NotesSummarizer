...
export function Flashcard({ front, back, index }: { front: string; back: string; index?: number }) {
  ...
  return (
    <button
      ...
      className="group relative h-52 w-full cursor-pointer rounded-2xl text-left [perspective:1200px] focus:outline-none focus-visible:ring-2 focus-visible:ring-mint-500/50 rounded-2xl"
    >
      <motion.div
